...
.method public run()V
    ...
    const-string v2, "interstitialAd.isAdInvalidated() = "

    :try_start_0
    iget-object v3, p0, Lcom/ironsource/adapters/facebook/FacebookAdapter$4;->this$0:Lcom/ironsource/adapters/facebook/FacebookAdapter;

    .line 538
    iget-object v3, v3, Lcom/ironsource/adapters/facebook/FacebookAdapter;->mISPlacementToAdMap:Ljava/util/concurrent/ConcurrentHashMap;

    iget-object v4, p0, Lcom/ironsource/adapters/facebook/FacebookAdapter$4;->val$placementId:Ljava/lang/String;

    invoke-virtual {v3, v4}, Ljava/util/concurrent/ConcurrentHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lcom/facebook/ads/InterstitialAd;

    if-eqz v3, :cond_0

    .line 539
    invoke-virtual {v3}, Lcom/facebook/ads/InterstitialAd;->isAdLoaded()Z

    move-result v4

    if-eqz v4, :cond_0

    invoke-virtual {v3}, Lcom/facebook/ads/InterstitialAd;->isAdInvalidated()Z
    ...
    .line 541
    invoke-virtual {v3}, Lcom/facebook/ads/InterstitialAd;->show()Z
