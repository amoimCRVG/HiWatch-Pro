...
.method static synthetic a(Lcom/baidu/location/b/g;Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method private a(Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p2, v7}, Ljavax/net/ssl/HttpsURLConnection;->setDoInput(Z)V

    invoke-virtual {p2, v7}, Ljavax/net/ssl/HttpsURLConnection;->setDoOutput(Z)V

    const/4 v7, 0x0

    invoke-virtual {p2, v7}, Ljavax/net/ssl/HttpsURLConnection;->setUseCaches(Z)V

    const-string v8, "POST"

    invoke-virtual {p2, v8}, Ljavax/net/ssl/HttpsURLConnection;->setRequestMethod(Ljava/lang/String;)V

    const-string v8, "Charset"

    const-string v9, "utf-8"

    invoke-virtual {p2, v8, v9}, Ljavax/net/ssl/HttpsURLConnection;->setRequestProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, v8, v4}, Ljavax/net/ssl/HttpsURLConnection;->setRequestProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v8, p1, v7, v1}, Ljava/io/DataOutputStream;->write([BII)V
...
.method static synthetic a(Lcom/baidu/location/b/g;Landroid/location/Location;)V
    .locals 0
...
.method private f()Z
    ...
    :cond_0
    iput v2, p0, Lcom/baidu/location/b/g;->D:I
    ...
    iget-wide v4, p0, Lcom/baidu/location/b/g;->t:D
...
.method private h()V
    ...
    iget v3, p0, Lcom/baidu/location/b/g;->L:I
    ...
    invoke-virtual {v0}, Lcom/baidu/location/b/i;->start()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
